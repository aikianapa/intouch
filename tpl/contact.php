        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 large">
                    ...
                    <p><span class="text-primary w-50px text-center fa fa-lg fa-envelope"></span> {{_SETT[evisa_mail]}}</p>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <form action="/ajax/mailer" method="post" class="ajax-form contacts-form" novalidate>
                            ...
                            <div class="form-group ">
                                <textarea class="form-control" name="message" rows="auto" data-label="Message" placeholder="" minlength="20" required></textarea>
                            </div>
