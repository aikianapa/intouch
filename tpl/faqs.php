        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="row no-gutters faq-categories" role="tree" data-wb-item="faqs" data-wb-children="false">
                ...
                <div class="col-12 col-lg-8">
                    <div class="tab-content" role="tree" data-wb-item="faqs" data-wb-level="0">
                        ...
                        <div class="tab-pane fade show {{_VAR[active]}}" id="tab-{{id}}">
                            <div id="tab-{{_VAR[category]}}-accordion" data-children=".faq-answer"  role="tree" data-wb-item="faqs" data-wb-branch="{{id}}" data-wb-parent="false">
                                <section class="faq-answer">
                                    <a data-toggle="collapse" data-parent="#tab-{{_VAR[category]}}-accordion" href="#tab-{{id}}" class="collapsed">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h2 class="h5 faq-answer-heading">{{data[{{_VAR[lang]}}]}}</h2>
