            ...
            <table class="table table-lightborder">
                ...
                <tbody data-wb-role="foreach" data-wb-table="{{_GET[form]}}" data-wb-add="true" data-wb-size="12" data-wb-sort="date:d">
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="status-pill green" data-title="В статьи" data-wb-role="where" data='article="on"' data-toggle="tooltip"></div>
                            <div class="status-pill red" data-title="Не статья" data-wb-role="where" data='article=""' data-toggle="tooltip"></div>
                        </td>
                        <td class="text-center">
